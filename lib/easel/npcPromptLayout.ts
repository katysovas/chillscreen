import { EASEL_DISPLAY_WIDTH, EASEL_NPC_HALF_WIDTH_PX, EASEL_NPC_STAND_GAP } from './layout';
...
export function npcPromptCanvasWorldX(npcWorldX: number): number {
  const frameLeft = npcWorldX + EASEL_NPC_HALF_WIDTH_PX + EASEL_NPC_STAND_GAP;
