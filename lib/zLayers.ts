...
/** Edge nav signs (prev/next stage) — above crowd, below ambient chat. */
export const Z_NAV_SIGNS = Z_PLAYER_CHARACTER + 1;

/** Visible ambient/public chat bubbles — above nav signs; latest bumps to Z_CHAT_OVERLAY. */
export const Z_AMBIENT_CHAT = Z_NAV_SIGNS + 2;
