export const DJ_STYLES = `
  .ch-dj-phones{position:absolute;left:50%;top:-96px;width:300px;height:181px;transform:translateX(-50%);z-index:14;pointer-events:none;}
  .ch-dj-phones-img{display:block;width:100%;height:100%;object-fit:contain;object-position:center bottom;transform:scaleX(1.5);transform-origin:center bottom;pointer-events:none;user-select:none;}
