...
export const LOADOUT_STYLES = `
  ...
  .ch-right-hand .ch-lo-brush{position:absolute;left:-2px;top:-100px;width:120px;height:120px;transform:scaleX(var(--ch-mirror,1)) rotate(180deg);transform-origin:50% 88%;z-index:12;pointer-events:none;}
  .ch-lo-brush-stroke{width:100%;height:100%;transform-origin:50% 88%;}
  ...
  @keyframes ch-brush-stroke{
    ...
    28%{transform:rotate(28deg) translate(-3px,4px);}
    52%{transform:rotate(6deg) translate(1px,2px);}
    78%{transform:rotate(36deg) translate(-2px,3px);}
  }
