...
export const LOADOUT_CATALOG: Record<string, LoadoutItemDef> = {
  ...
  'instrument-guitar-1': {
    ...
    description: 'Strum between sets on the lawn.',
    vendorPrice: 250,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-guitar-acoustic': {
    id: 'instrument-guitar-acoustic',
    slot: 'hand',
    name: 'Classic Acoustic',
    description: 'Warm wood tones for the campfire circle.',
    vendorPrice: 250,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-guitar-bass': {
    ...
    slot: 'hand',
    name: 'Bass Guitar',
    description: 'Low-end groove for the late-night jam.',
    vendorPrice: 275,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-guitar-electric-1': {
    id: 'instrument-guitar-electric-1',
    slot: 'hand',
    name: 'Electric Guitar',
    description: 'Cranked up for the main-stage encore.',
    vendorPrice: 300,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-guitar-electric': {
    id: 'instrument-guitar-electric',
    slot: 'hand',
    name: 'Solid Electric',
    description: 'A sleek body built for festival solos.',
    vendorPrice: 300,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-guitar': {
    ...
    slot: 'hand',
    name: 'Festival Guitar',
    description: 'A trusty six-string for the wandering set.',
    vendorPrice: 250,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-drums': {
    ...
    slot: 'hand',
    name: 'Drum Kit',
    description: 'A compact kit for impromptu festival grooves.',
    vendorPrice: 350,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-bongo': {
    ...
    slot: 'hand',
    name: 'Bongos',
    description: 'Hand drums for a quick rhythm on the lawn.',
    vendorPrice: 280,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
  ...
  'instrument-trumpet': {
    ...
    slot: 'hand',
    name: 'Trumpet',
    description: 'Brass lines for the sunset brass jam.',
    vendorPrice: 300,
    handMounted: true,
    holdSide: 'right',
    defaultProps: {},
